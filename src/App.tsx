  ...
  return (
    <div className="min-h-screen h-100 bg-lightYellow flex flex-col items-center p-6">
      <header className="sticky top-0 bg-lightYellow z-40 w-full text-center">
        ...
        <nav className="bg-lightGray md:rounded-full md:px-6 md:bottom-auto md:relative md:text-md md:w-max md:mx-auto w-full text-sm shadow-md flex justify-center fixed left-0 bottom-0 z-40">
